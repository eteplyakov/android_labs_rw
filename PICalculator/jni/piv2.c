...
jstring Java_com_example_picalculator_PiCalculateService_calculatePi(JNIEnv *env, jobject obj, jint fft, jstring precision)
{
    ...
    /* ---- difftime ---- */
    char time[6]="";
    sprintf( time, "%.0f", difftime(t_2, t_1));
